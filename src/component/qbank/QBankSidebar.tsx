          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full group relative rounded-lg px-4 py-3 text-sm font-medium transition-all duration-200 cursor-pointer ${
                  isActive
                ...
                <div className="flex items-center gap-3">
                  <Icon
                    className={`w-5 h-5 transition-colors ${
                      isActive
                        ? "text-dark"
                        : "text-dark group-hover:text-gray-600"
                    }`}
                  />
