  ...
  return <section className="bg-[#100b16] py-24 px-6 overflow-hidden relative min-h-[600px] flex items-center border-b-2 border-[#1E1A29]">
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10">
        ...
        <div className="text-left">
          ...
          <motion.h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6 ff-font-bold tracking-tight max-w-3xl" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{
          once: true,
          margin: "-50px"
        }} transition={{
          duration: 0.6
