  ...
  return (
    <div className="group flex-shrink-0 w-[340px] cursor-pointer bg-white border-2 border-gray-200 rounded-3xl p-6 transition-all duration-500 hover:-translate-y-0 flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10">
          ...
          <div className="relative mb-3 group/tags ">
            ...
            >
              {tags?.map((tag, idx) => (
                <span
                  key={idx}
                  className="flex-shrink-0 text-xs px-3 py-1.5 bg-[#f3f6fa] ff-font rounded-full font-medium shadow-sm hover:shadow-md transition-shadow scroll-snap-align-start"
                >
                  {tag}
                </span>
              ))}
        ...
        {/* More Features */}
        {moreFeatures > 0 && (
          <button className="text-xs text-black ff-font-bold text-left mb-4 flex  items-center gap-1 font-medium group/btn">
        ...
        <p className="text-sm ff-font  mb-6 flex-grow leading-relaxed line-clamp-2 min-h-[3.2rem]">
        ...
        <p className="text-xsff-font text-center mt-3 font-sm">
