...
function AdvancedPathologyPrograms() {
    ...
    const recordedProgram = {
        ...
        category: "https://st2.depositphotos.com/1000434/11667/i/450/depositphotos_116673844-stock-photo-amoeba-on-blue-background.jpg",
        rating: 4.9,
        price: 59.99,
        originalPrice: 79.99,
    };
        ...
        <main className="flex flex-col items-center justify-center min-h-[60vh] bg-white px-4 md:px-6 lg:px-8 py-10">
            ...
            <section className="w-full max-w-[1025px] mx-auto  mt-10">
                <div className="mb-6 text-left">
                    <h2 className="text-2xl font-bold text-gray-900">Recorded Programs</h2>
            ...
            <section className="w-full max-w-[1025px] mx-auto mt-10">
                <div className="mb-6 text-left">
                    <h2 className="text-2xl font-bold text-gray-900">Upcoming Programs</h2>
                    <p className="text-gray-500 text-sm">
