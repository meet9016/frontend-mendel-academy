...
const WhoEnroll = ({ plans }) => {
    ...
    return (
        ...
        ${index === 1 ? 'border-[#ffcb04] shadow-xl bg-gradient-to-br from-yellow-50 via-white to-amber-50' : 'border-gray-200'}
      `}
                                >
                                    ...
                                    <div className="flex flex-col justify-between h-full space-y-6 mt-2">
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-2 text-center">
                                                <p className="text-4xl font-bold text-[#ffcb04]">{plan.plan_pricing}</p>
                                                <p className="text-xs text-gray-500">(Plus 18% GST)</p>
                                            </div>
