      ...
      <div className="w-full bg-black  border-t-4 border-primary text-white rounded-xl p-6 md:px-8 md:py-6 flex flex-col md:flex-row justify-between items-center gap-6 ">
        ...
        <div className="flex items-start md:items-center gap-5 w-full md:w-auto">
          ...
          <div className="flex-1 space-y-1">
            ...
            <div className="inline-flex items-center gap-2 bg-[#2d2d2d] px-2.5 py-1 rounded text-[10px] font-bold text-primary tracking-widest uppercase">
        ...
        <div className="flex gap-3 w-full md:w-auto shrink-0">
          ...
          <button className="flex-1 md:flex-none px-6 py-2.5 bg-primary text-black rounded-lg text-sm ff-font ">
            Upgrade now
          </button>
        </div>
      </div>
